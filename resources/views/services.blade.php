    ...
    <body>
            <header class="stick">
                    ...
                    <div class="logo-menu-sec">
                        <div class="container">
                            <div class="logo"><h1 itemprop="headline"><a href={{asset("/")}} title="Home" itemprop="url"><img src="assets/images/logo2.png" alt="logo.png" itemprop="image"></a></h1></div>
                            <nav>
                                <div class="menu-sec">
                                    <ul>
            ...
            <section>
                    <div class="block">
                        <div class="fixed-bg" style="background-image: url(assets/images/topbg.jpg); height:50% ; margin-top: 11%"></div>
                                    ...
                                    <div class="resturent-services remove-ext">
    									...
    									<div class="col-md-4 col-sm-6">
    										<div class="servise-box wow fadeIn" data-wow-delay="0.4s">
    											...
    											<div class="uper-meta">
    												...
    												<h4><a href="#" title="">Fast Food Delivery</a></h4>
    									...
    									<div class="col-md-4 col-sm-6">
    										<div class="servise-box wow fadeIn" data-wow-delay="0.5s">
    											...
    											<div class="uper-meta">
    												<i><img src="assets/images/icon2.png" alt=""></i>
    												<h4><a href="#" title="">Best Price</a></h4>
    									...
    									<div class="col-md-4 col-sm-6">
    										<div class="servise-box wow fadeIn" data-wow-delay="0.6s">
    											...
    											<div class="uper-meta">
    												<i><img src="assets/images/icon1.png" alt=""></i>
    												<h4><a href="#" title="">Offers and packages</a></h4>
