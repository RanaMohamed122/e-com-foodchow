...
class ProductsController extends Controller
{
	public function addProduct(Request $request){
		...
		if($request->isMethod('post')){
            ...
            $product->chef_id = $data['chef_id'];
			$product->product_name = $data['product_name'];
            $product->delivery_time = $data['delivery_time'];
            $product->project_name = $data['project_name'];
		...
		$chefs_drop_down = "<option value='' selected disabled>Select</option>";
		foreach($chefs as $chef){
			$chefs_drop_down .= "<option value='".$chef->id."'>".$chef->project_name."</option>";
			//$sub_categories = Category::where(['parent_id' => $cat->id])->get();
			//foreach($sub_categories as $sub_cat){
				//$categories_drop_down .= "<option value='".$sub_cat->id."'>&nbsp;&nbsp;--&nbsp;".$sub_cat->name."</option>";	
			//}	
		...
		return view('admin.products.add_product')->with(compact('categories_drop_down', 'chefs_drop_down'));
	}  
